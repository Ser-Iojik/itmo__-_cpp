...
int main(void) {
	float x, x1, x2, x3, a, a1, a2, a3, sum, y;
	int kol;
	// setlocale(LC_ALL, "Russian"); // V pizdu russian language
	printf("%s", "Input min x = ");
	scanf("%f", &x1); // %f -> Input x1 how float

	printf("%s", "Input max x = ");
	scanf("%f", &x2);

	printf("%s", "Input step x = ");
	scanf("%f", &x3);
	

	printf("%s", "Input min a = ");
	scanf("%f", &a1);

	printf("%s", "Input max a = ");
	scanf("%f", &a2);

	printf("%s", "Input step a = ");
	scanf("%f", &a3);
	...
	if (sum > 0)
		printf("%d %f/n", "kol/sum =", kol / sum);
	else
		printf("%s", "Does not exist y > 0");
	// system("pause");
